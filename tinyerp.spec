...
%exclude %{_libdir}/python2.5/site-packages/tinyerp_client-4.0.3-py2.5.egg-info
...
%exclude %{_libdir}/python2.5/site-packages/tinyerp_server-4.0.3-py2.5.egg-info
